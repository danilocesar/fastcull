# ui-grid.md before the 2026-09-17 rewrite (brief 007)

Verbatim (after the harness section had moved to test-harness.md the same day). The live spec is `specs/modules/ui-grid.md`.
